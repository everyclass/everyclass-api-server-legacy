...
from everyclass.api_server import logger
...
def get_classes_for_student(student_id: str, sem: Semester) -> dict:
    ...
    """
    from everyclass.api_server.exceptions import NoStudentException, IllegalSemesterException
...
def get_students_in_class(class_id: str):
    ...
    from everyclass.api_server.exceptions import NoStudentException, NoClassException
