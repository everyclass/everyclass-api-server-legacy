...
from everyclass.api_server.api import api_v1
...
def get_semesters(student_id):
    ...
    :param student_id: 学号
    """
    from everyclass.api_server.db.dao import get_my_semesters
...
def get_courses(student_id, semester):
    ...
    """
    import json
    from everyclass.api_server.db.dao import get_classes_for_student
    from everyclass.api_server.db.model import Semester
    from everyclass.api_server.exceptions import IllegalSemesterException, NoStudentException
...
def error_handler_500(error):
    """handle 500 error"""
    response = jsonify({'error': 'api_server internal error'})
